...
" Colours {{{1
"" General {{{2
hi Normal       ctermfg=252 guifg=#d0d0d0 ctermbg=black guibg=#000000 cterm=none gui=none
...
" TODO
" hi MoreMsg
hi NonText      ctermfg=247 guifg=#9e9e9e ctermbg=black guibg=#000000 cterm=bold gui=bold
...
hi StatusLine   ctermfg=15  guifg=#ffffff ctermbg=255 guibg=#4e4e4e cterm=bold gui=bold
